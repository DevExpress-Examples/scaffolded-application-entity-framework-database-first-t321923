...
Namespace Global.DevExpressWalkthrough.VB.Common.ViewModel
    Public Partial Class InstantFeedbackCollectionViewModel(Of TEntity As {Class, New}, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        End Sub
    End Class
    Public Partial Class InstantFeedbackCollectionViewModel(Of TEntity As {Class, New}, TProjection As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
    ...
    Public MustInherit Class InstantFeedbackCollectionViewModelBase(Of TEntity As {Class, New}, TProjection As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        Public Class InstantFeedbackSourceViewModel
            ...
            Public Sub Refresh()
                _source.Refresh()
                Me.RaisePropertyChanged(Function(ByVal x) x.Count)
            End Sub
        ...
        End Sub
        Public Overridable Function CanEdit(ByVal threadSafeProxy As Object) As Boolean
        ...
        Public Overridable Sub Delete(ByVal threadSafeProxy As Object)
            ...
            Refresh()
        End Sub
        Public Overridable Function CanDelete(ByVal threadSafeProxy As Object) As Boolean
            Return threadSafeProxy IsNot Nothing
        End Function
        ...
        Protected Function GetProxyPrimaryKey(ByVal threadSafeProxy As Object) As TPrimaryKey
            Dim expression = RepositoryExtensions.GetSinglePropertyPrimaryKeyProjectionProperty(Of TEntity, TProjection, TPrimaryKey)(_helperRepository)
