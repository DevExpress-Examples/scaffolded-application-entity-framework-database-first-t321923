    ...
    Public MustInherit Class SingleObjectViewModelBase(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        Protected Overridable Function SaveCore() As Boolean
            Try
                ...
                Me.RaisePropertyChanged(Function(ByVal x) x.IsPrimaryKeyReadOnly)
                Return True
            Catch e As DbException
                MessageBoxService.ShowMessage(e.ErrorMessage, e.ErrorCaption, MessageButton.OK, MessageIcon.[Error])
                Return False
        ...
        Protected Overridable Sub OnEntitySaved(ByVal primaryKey As TPrimaryKey, ByVal entity As TEntity, ByVal isNewEntity As Boolean)
            Messenger.[Default].Send(New EntityMessage(Of TEntity, TPrimaryKey)(primaryKey, If(isNewEntity, EntityMessageType.Added, EntityMessageType.Changed), Me))
        End Sub
        ...
        Protected Overridable Sub OnInitializeInRuntime()
            ...
            Messenger.[Default].Register(Of CloseAllMessage)(Me, Sub(ByVal m)
        ...
        Protected Function CreateAddRemoveDetailEntitiesViewModel(Of TDetailEntity As Class, TDetailPrimaryKey)(ByVal getDetailsRepositoryFunc As Func(Of TUnitOfWork, IRepository(Of TDetailEntity, TDetailPrimaryKey)), ByVal getDetailsFunc As Func(Of TEntity, ICollection(Of TDetailEntity))) As AddRemoveDetailEntitiesViewModel(Of TEntity, TPrimaryKey, TDetailEntity, TDetailPrimaryKey, TUnitOfWork)
            Dim viewModel = AddRemoveDetailEntitiesViewModel(Of TEntity, TPrimaryKey, TDetailEntity, TDetailPrimaryKey, TUnitOfWork).Create(UnitOfWorkFactory, Me.getRepositoryFunc, getDetailsRepositoryFunc, getDetailsFunc, PrimaryKey)
            viewModel.SetParentViewModel(Me)
            Return viewModel
        End Function
        Protected Function CreateAddRemoveJunctionDetailEntitiesViewModel(Of TDetailEntity As Class, TDetailPrimaryKey, TJunction As {Class, New}, TJunctionPrimaryKey As Class)(ByVal getDetailsRepositoryFunc As Func(Of TUnitOfWork, IRepository(Of TDetailEntity, TDetailPrimaryKey)), ByVal getJunctionRepositoryFunc As Func(Of TUnitOfWork, IRepository(Of TJunction, TJunctionPrimaryKey)), ByVal getEntityForeignKey As Expression(Of Func(Of TJunction, TPrimaryKey)), ByVal getDetailForeignKey As Expression(Of Func(Of TJunction, TDetailPrimaryKey))) As AddRemoveJunctionDetailEntitiesViewModel(Of TEntity, TPrimaryKey, TDetailEntity, TDetailPrimaryKey, TJunction, TJunctionPrimaryKey, TUnitOfWork)
            Dim viewModel = AddRemoveJunctionDetailEntitiesViewModel(Of TEntity, TPrimaryKey, TDetailEntity, TDetailPrimaryKey, TJunction, TJunctionPrimaryKey, TUnitOfWork).CreateViewModel(UnitOfWorkFactory, Me.getRepositoryFunc, getDetailsRepositoryFunc, getJunctionRepositoryFunc, getEntityForeignKey, getDetailForeignKey, PrimaryKey)
            viewModel.SetParentViewModel(Me)
            Return viewModel
        End Function
        ...
        Private Function CreateForeignKeyPropertyInitializer(Of TDetailEntity As Class, TForeignKey)(ByVal setMasterEntityKeyAction As Action(Of TDetailEntity, TPrimaryKey), ByVal getMasterEntityKey As Func(Of TForeignKey)) As Action(Of TDetailEntity)
            Return Sub(ByVal x) setMasterEntityKeyAction(x, CType(CType(getMasterEntityKey(), Object), TPrimaryKey))
        End Function
