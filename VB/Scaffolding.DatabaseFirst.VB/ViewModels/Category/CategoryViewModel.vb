...
Namespace Global.Scaffolding.DatabaseFirst.VB.ViewModels
    ...
    Public Partial Class CategoryViewModel
        ...
        Public ReadOnly Property LookUpProducts As IEntitiesViewModel(Of Product)
            Get
                Return GetLookUpEntitiesViewModel(propertyExpression:=Function(ByVal x As CategoryViewModel) x.LookUpProducts, getRepositoryFunc:=Function(ByVal x) x.Products)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property CategoryProductsDetails As CollectionViewModelBase(Of Product, Product, Integer, INorthwindEntitiesUnitOfWork)
            Get
                Return GetDetailsCollectionViewModel(propertyExpression:=Function(ByVal x As CategoryViewModel) x.CategoryProductsDetails, getRepositoryFunc:=Function(ByVal x) x.Products, foreignKeyExpression:=Function(ByVal x) x.CategoryID, navigationExpression:=Function(ByVal x) x.Category)
            End Get
        End Property
    End Class
End Namespace
