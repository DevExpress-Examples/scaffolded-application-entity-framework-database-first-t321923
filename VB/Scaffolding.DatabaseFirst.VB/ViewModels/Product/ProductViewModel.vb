...
Namespace Global.Scaffolding.DatabaseFirst.VB.ViewModels
    ...
    Public Partial Class ProductViewModel
        ...
        Public ReadOnly Property LookUpOrder_Details As IEntitiesViewModel(Of Order_Detail)
            Get
                Return GetLookUpEntitiesViewModel(propertyExpression:=Function(ByVal x As ProductViewModel) x.LookUpOrder_Details, getRepositoryFunc:=Function(ByVal x) x.Order_Details)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property LookUpCategories As IEntitiesViewModel(Of Category)
            Get
                Return GetLookUpEntitiesViewModel(propertyExpression:=Function(ByVal x As ProductViewModel) x.LookUpCategories, getRepositoryFunc:=Function(ByVal x) x.Categories)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property LookUpSuppliers As IEntitiesViewModel(Of Supplier)
            Get
                Return GetLookUpEntitiesViewModel(propertyExpression:=Function(ByVal x As ProductViewModel) x.LookUpSuppliers, getRepositoryFunc:=Function(ByVal x) x.Suppliers)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property ProductOrder_DetailsDetails As CollectionViewModelBase(Of Order_Detail, Order_Detail, Tuple(Of Integer, Integer), INorthwindEntitiesUnitOfWork)
            Get
                Return GetDetailsCollectionViewModel(propertyExpression:=Function(ByVal x As ProductViewModel) x.ProductOrder_DetailsDetails, getRepositoryFunc:=Function(ByVal x) x.Order_Details, foreignKeyExpression:=Function(ByVal x) x.ProductID, navigationExpression:=Function(ByVal x) x.Product)
            End Get
        End Property
    End Class
End Namespace
