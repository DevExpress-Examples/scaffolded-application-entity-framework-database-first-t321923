...
Namespace Global.Scaffolding.DatabaseFirst.VB.ViewModels
    ...
    Public Partial Class SupplierViewModel
        ...
        Public ReadOnly Property LookUpProducts As IEntitiesViewModel(Of Product)
            Get
                Return GetLookUpEntitiesViewModel(propertyExpression:=Function(ByVal x As SupplierViewModel) x.LookUpProducts, getRepositoryFunc:=Function(ByVal x) x.Products)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property SupplierProductsDetails As CollectionViewModelBase(Of Product, Product, Integer, INorthwindEntitiesUnitOfWork)
            Get
                Return GetDetailsCollectionViewModel(propertyExpression:=Function(ByVal x As SupplierViewModel) x.SupplierProductsDetails, getRepositoryFunc:=Function(ByVal x) x.Products, foreignKeyExpression:=Function(ByVal x) x.SupplierID, navigationExpression:=Function(ByVal x) x.Supplier)
            End Get
        End Property
    End Class
End Namespace
