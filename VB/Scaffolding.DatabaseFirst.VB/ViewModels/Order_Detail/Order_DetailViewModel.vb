...
Namespace Global.Scaffolding.DatabaseFirst.VB.ViewModels
    ...
    Public Partial Class Order_DetailViewModel
        ...
        Public ReadOnly Property LookUpOrders As IEntitiesViewModel(Of Order)
            Get
                Return GetLookUpEntitiesViewModel(Function(ByVal x As Order_DetailViewModel) x.LookUpOrders, Function(ByVal x) x.Orders)
            End Get
        End Property
        ''' <summary>
        ...
        Public ReadOnly Property LookUpProducts As IEntitiesViewModel(Of Product)
            Get
                Return GetLookUpEntitiesViewModel(Function(ByVal x As Order_DetailViewModel) x.LookUpProducts, Function(ByVal x) x.Products)
            End Get
        End Property
    End Class
End Namespace
